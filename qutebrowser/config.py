...
# homepage = 'https://searx.reyuzenfold.com'
# c.url.default_page = homepage
# c.url.start_pages = homepage
# c.url.searchengines = {'DEFAULT': 'https://searx.reyuzenfold.com/?q={}'}

c.auto_save.session = True
c.tabs.show = 'multiple'

c.downloads.location.directory = '/home/reyu/Downloads'
c.editor.command = ['st', '-e', 'nvim', '{file}', '-c', 'normal {line}G{column0}l']

c.hints.chars = "aoeuidhtns"
c.content.javascript.enabled = False
config.set('content.javascript.enabled', True, '*://*.blackfoxcode.com/*')
config.set('content.javascript.enabled', True, '*://*.reyuzenfold.com/*')
config.set('content.javascript.enabled', True, '*://*.canidcomics.com/*')
config.set('content.javascript.enabled', True, 'https://*.protonmail.com/*')
config.set('content.javascript.enabled', True, 'https://*.cloud.google.com/*')
config.set('content.javascript.enabled', True, 'https://accounts.google.com/*')
config.set('content.javascript.enabled', True, 'https://admin.google.com/*')
...
config.set('content.javascript.enabled', True, 'https://gist.github.com/*')
config.set('content.javascript.enabled', True, 'https://smile.amazon.com/*')
